  ...
  return (
    <div style={{ padding: '0 20px 100px', display: 'flex', flexDirection: 'column', gap: '24px' }} className="animate-fade-in">
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
        ...
        <h2 style={{ fontSize: '24px', fontWeight: 900, color: '#2b2a28', margin: 0 }}>Wheat Profile</h2>
      </div>

      {/* Hero Image */}
      <div style={{ width: '100%', height: '220px', borderRadius: '24px', overflow: 'hidden', position: 'relative' }}>
        <img src="https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?q=80&w=600&auto=format&fit=crop" style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Wheat" />
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'linear-gradient(transparent, rgba(0,0,0,0.8))', padding: '20px' }}>
          <h1 style={{ color: 'white', fontSize: '32px', margin: 0, fontWeight: 900 }}>Wheat</h1>
          <p style={{ color: '#eaeaed', fontSize: '14px', margin: 0, fontWeight: 600 }}>TRITICUM</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '16px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '20px', padding: '24px', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
          ...
          <p style={{ margin: 0, fontSize: '16px', color: '#4a4641', lineHeight: '1.5', fontWeight: 500 }}>
            <strong style={{ color: '#2b2a28' }}>Rabi Season (Winter)</strong>
            <br />
        ...
        <div style={{ background: 'white', borderRadius: '20px', padding: '24px', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
            <h2 style={{ margin: 0, fontSize: '36px', fontWeight: 900, color: '#059669' }}>₹2,275</h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
          <div style={{ background: 'white', borderRadius: '20px', padding: '20px', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
            ...
            <div style={{ fontSize: '16px', fontWeight: 700, color: '#2b2a28' }}>10°C - 25°C</div>
          </div>
          <div style={{ background: 'white', borderRadius: '20px', padding: '20px', boxShadow: '0 4px 15px rgba(0,0,0,0.03)' }}>
            ...
            <div style={{ fontSize: '16px', fontWeight: 700, color: '#2b2a28' }}>50 - 100 cm</div>
          </div>
        </div>
      </div>
    </div>
